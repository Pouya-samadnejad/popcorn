        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMoviesList
                watched={watched}
                onDeleteWhatchedMovie={handleDeleteWatchedMovie}
              />
            </>
          )}
        </Box>
...
function MovieDetail({ selectedId, onCloseId, onAddWatched, watched }) {
  ...
  return (
    <div className="details">
      <header>
        ...
        <image src={poster} alt={`Poster of ${title}`} />
...
function WatchedMoviesList({ watched, onDeleteWhatchedMovie }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
          movie={movie}
          key={movie.imdbID}
          onDeleteWhatchedMovie={onDeleteWhatchedMovie}
        />
      ))}
    </ul>
  );
...
function WatchedMovie({ movie, onDeleteWhatchedMovie }) {
  return (
    <li>
      <img src={movie.poster} alt={`${movie.Title} poster`} />
      <h3>{movie.title}</h3>
      ...
      <button
        ...
        onClick={() => onDeleteWhatchedMovie(movie.imdbID)}
      >
        X
      </button>
    </li>
